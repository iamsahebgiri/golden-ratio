...
export default function index() {
  return (
    <footer className="bg-gray-50 border-t border-gray-200 py-12 md:py-14 px-8 sm:px-6 lg:px-16 text-sm leading-5">
      <div className="max-w-container mx-auto flex flex-col md:flex-row items-center justify-between  text-center space-y-6 md:space-y-0 md:text-left md:flex">
        ...
        <div>
          <a href="https://twitter.com/iamsahebgiri" target="_blank" rel="noreferrer" className="inline-flex items-center space-x-6 mr-4 text-twitter-blue ml-auto font-medium">
            <AiOutlineTwitter size="24" className="text-gray-500  hover:text-blue-600" />
          </a>
          <a href="https://facebook.com/iamsahebgiri" target="_blank" rel="noreferrer" className="inline-flex items-center space-x-6 mr-4 text-twitter-blue ml-auto font-medium">
            <AiFillFacebook size="24" className="text-gray-500 hover:text-blue-brand" />
          </a>
          <a href="https://instagram.com/iamsahebgiri" target="_blank" rel="noreferrer" className="inline-flex items-center space-x-6 mr-4 text-twitter-blue ml-auto font-medium">
